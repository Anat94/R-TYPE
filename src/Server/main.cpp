...
int main(int argc, char *argv[]) {
    ...
    ecs.register_component<component::SurvivesOutOfBound>();
    ...
    ecs.add_system<component::Position, component::Velocity, component::SurvivesOutOfBound>(*kill_sys);
    PositionSystem *pos_sys = new PositionSystem(&listener);
    ecs.add_system<component::Position, component::Velocity, component::SurvivesOutOfBound>(*pos_sys);
